  ...
  (function renderReservationTimeline() {
    ...
    el.innerHTML = rows.map(function (row) {
      ...
      return '<li class="timeline-row ' + cls + '">' +
        ...
        '<p class="tl-note">' + (platform ? reservationBadgeHTML(platform) : esc('Verify booking channel directly with the venue')) +
